const PropertyCard = ({ imgUrl, name, price, carSlotsNum, bathtubNum, foots }) => {
  return (
    <div
      ...
      <div className="flex flex-row py-0 px-2.5 items-start justify-start gap-[17px] text-[10.84px] text-gray-500">
        <div className="flex flex-row items-center justify-start gap-[4.35px]">
          <img
            ...
            src="/car.svg"
          />
          <div className="relative leading-[16.27px] font-medium">{carSlotsNum}</div>
        </div>
        <div className="flex flex-row items-center justify-start gap-[4.35px]">
          <img
            className="w-[17.42px] h-[17.42px]"
            ...
            src="/bathtub.svg"
          />
          <div className="relative leading-[16.27px] font-medium">{bathtubNum}</div>
        </div>
        <div className="flex flex-row items-center justify-start gap-[4.35px]">
          <img
            className="w-[17.42px] h-[17.42px]"
